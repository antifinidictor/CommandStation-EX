...
// 2A / channel (1900mA), (5V/1024) / 1.65V/A * 1000 -> 2.96
#define ARDUINO_MOTOR_SHIELD_REV3 F("ARDUINO_MOTOR_SHIELD_REV3"),      \
	new MotorDriver(3, 12, UNUSED_PIN, 9, A0, 2.96, 1900, UNUSED_PIN), \
	new MotorDriver(11, 13, UNUSED_PIN, 8, A1, 2.96, 1900, UNUSED_PIN)
...
//   +-----------------------v
//
#define MOTOR_SHIELD_TYPE ARDUINO_MOTOR_SHIELD_REV3
//
/////////////////////////////////////////////////////////////////////////////////////
//
...
// Instead of wifi, we'll be using bluetooth.
